...
You will need Fabric Loader 0.12.2 or newer installed in your game in order to load Sodium. If you haven't installed
...
- JDK 17 (optional)
  - If you neither have JDK 17 available on your shell's path or installed through a supported package manager (such as
