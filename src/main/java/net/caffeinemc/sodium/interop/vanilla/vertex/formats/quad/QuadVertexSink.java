...
public interface QuadVertexSink extends VertexSink {
    ...
    default void writeQuad(MatrixStack.Entry matrices, float x, float y, float z, int color, float u, float v, int light, int overlay, int normal) {
        ...
        float normX1 = Normal3b.unpackX(normal);
        float normY1 = Normal3b.unpackY(normal);
        float normZ1 = Normal3b.unpackZ(normal);
        ...
        this.writeQuad(x2, y2, z2, color, u, v, light, overlay, Normal3b.pack(normX2, normY2, normZ2));
    }
}
