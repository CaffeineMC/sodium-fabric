...
public class MixinWorldRenderer {
    ...
    public static void drawBox(MatrixStack matrices, VertexConsumer vertexConsumer, double x1, double y1, double z1,
        ...
        lines.vertexLine(v1x, v1y, v1z, ColorABGR.pack(red, yAxisGreen, zAxisBlue, alpha), Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));
        lines.vertexLine(v2x, v2y, v2z, ColorABGR.pack(red, yAxisGreen, zAxisBlue, alpha), Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));

        lines.vertexLine(v1x, v1y, v1z, ColorABGR.pack(xAxisRed, green, zAxisBlue, alpha), Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));
        lines.vertexLine(v3x, v3y, v3z, ColorABGR.pack(xAxisRed, green, zAxisBlue, alpha), Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));

        lines.vertexLine(v1x, v1y, v1z, ColorABGR.pack(xAxisRed, yAxisGreen, blue, alpha), Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));
        lines.vertexLine(v4x, v4y, v4z, ColorABGR.pack(xAxisRed, yAxisGreen, blue, alpha), Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));

        lines.vertexLine(v2x, v2y, v2z, color, Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));
        lines.vertexLine(v5x, v5y, v5z, color, Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));

        lines.vertexLine(v5x, v5y, v5z, color, Normal3b.pack(-normal.m00(), -normal.m10(), -normal.m20()));
        lines.vertexLine(v3x, v3y, v3z, color, Normal3b.pack(-normal.m00(), -normal.m10(), -normal.m20()));

        lines.vertexLine(v3x, v3y, v3z, color, Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));
        lines.vertexLine(v6x, v6y, v6z, color, Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));

        lines.vertexLine(v6x, v6y, v6z, color, Normal3b.pack(-normal.m01(), -normal.m11(), -normal.m21()));
        lines.vertexLine(v4x, v4y, v4z, color, Normal3b.pack(-normal.m01(), -normal.m11(), -normal.m21()));

        lines.vertexLine(v4x, v4y, v4z, color, Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));
        lines.vertexLine(v7x, v7y, v7z, color, Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));

        lines.vertexLine(v7x, v7y, v7z, color, Normal3b.pack(-normal.m02(), -normal.m12(), -normal.m22()));
        lines.vertexLine(v2x, v2y, v2z, color, Normal3b.pack(-normal.m02(), -normal.m12(), -normal.m22()));

        lines.vertexLine(v6x, v6y, v6z, color, Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));
        lines.vertexLine(v8x, v8y, v8z, color, Normal3b.pack(normal.m00(), normal.m10(), normal.m20()));

        lines.vertexLine(v7x, v7y, v7z, color, Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));
        lines.vertexLine(v8x, v8y, v8z, color, Normal3b.pack(normal.m01(), normal.m11(), normal.m21()));

        lines.vertexLine(v5x, v5y, v5z, color, Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));
        lines.vertexLine(v8x, v8y, v8z, color, Normal3b.pack(normal.m02(), normal.m12(), normal.m22()));
