...
public class SodiumOptionsGUI extends Screen implements ScreenPromptable {
    ...
    static {
        DONATION_PROMPT_MESSAGE = List.of(
                ...
                FormattedText.composite(Component.literal("It seems that you've been enjoying "), Component.literal("Sodium").withColor(0x27eb92), Component.literal(", the optimization mod for Minecraft.")),
