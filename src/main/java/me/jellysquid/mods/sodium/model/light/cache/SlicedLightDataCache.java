package me.jellysquid.mods.sodium.model.light.cache;
 ...
 */
public class SlicedLightDataCache extends LightDataAccess {
    ...
    public SlicedLightDataCache(BlockRenderView world) {
        this.world = world;
        this.light = new long[BLOCK_LENGTH * BLOCK_LENGTH * BLOCK_LENGTH];
    }

    public void prepare(ChunkSectionPos origin) {
