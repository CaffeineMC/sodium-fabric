...
public class DefaultRenderPasses {
    ...
    public static final ChunkRenderPass CUTOUT_MIPPED = new ChunkRenderPass(RenderPipeline.defaults(), true, 0.1f);
    public static final ChunkRenderPass CUTOUT = new ChunkRenderPass(RenderPipeline.defaults(), false, 0.5f);
