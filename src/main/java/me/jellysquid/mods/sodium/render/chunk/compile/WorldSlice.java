...
import me.jellysquid.mods.sodium.world.biome.BlockColorCache;
...
public class WorldSlice implements BlockRenderView, RenderAttachedBlockView {
    ...
    public void copyData(WorldSliceData context) {
        ...
        this.biomeColorCache = new BlockColorCache(this, MinecraftClient.getInstance().options.biomeBlendRadius);
    }
