 ...
 */
public class ProgramImpl<T> extends GlObject implements ShaderBindingContext, Program<T> {
    private static final Logger LOGGER = LogManager.getLogger(ProgramImpl.class);

    private final T shaderInterface;

    protected ProgramImpl(int program, Function<ShaderBindingContext, T> interfaceFactory) {
    ...
    public static class Builder {
        ...
        public Builder attachShader(ShaderImpl shader) {
         ...
         */
        public <U> ProgramImpl<U> link(Function<ShaderBindingContext, U> factory) {
            ...
            return new ProgramImpl<>(this.program, factory);
        }
