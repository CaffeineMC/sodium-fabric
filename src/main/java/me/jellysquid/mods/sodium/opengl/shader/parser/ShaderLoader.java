...
public class ShaderLoader {
     ...
     */
    public static ShaderImpl loadShader(ShaderType type, Identifier name, ShaderConstants constants) {
        return new ShaderImpl(type, name, ShaderParser.parseShader(getShaderSource(name), constants));
    }
