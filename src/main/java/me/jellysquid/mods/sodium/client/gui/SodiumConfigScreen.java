...
import me.jellysquid.mods.sodium.client.gui.options.ControlElement;
...
public class SodiumConfigScreen extends Screen {
    ...
    public SodiumConfigScreen(Screen prevScreen) {
    ...
    private void hideDonationButton() {
        SodiumRenderConfig options = SodiumClientMod.options();
