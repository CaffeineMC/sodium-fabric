...
import me.jellysquid.mods.sodium.client.gui.options.OptionImpl.BuilderFactory;
...
public class SodiumGameOptionPages {
    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.integerFactory.createBuilder(vanillaOpts)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.integerFactory.createBuilder(vanillaOpts)
                        ...
                        .build())
                .add(BuilderFactory.booleanFactory.createBuilder(vanillaOpts)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.booleanFactory.createBuilder(vanillaOpts)
                        ...
                        .build())
                .add(BuilderFactory.attackIndicatorFactory.createBuilder(vanillaOpts)
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.graphicsModeFactory.createBuilder(vanillaOpts)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.cloudRenderModeFactory.createBuilder(vanillaOpts)
                        ...
                        .build())
                .add(BuilderFactory.graphicsQualityFactory.createBuilder(sodiumOpts)
                ...
                .add(BuilderFactory.graphicsQualityFactory.createBuilder(sodiumOpts)
                        ...
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                        .build())
                .add(BuilderFactory.particlesModeFactory.createBuilder(vanillaOpts)
                ...
                .add(BuilderFactory.booleanFactory.createBuilder(vanillaOpts)
                        ...
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(BuilderFactory.booleanFactory.createBuilder(sodiumOpts)
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.integerFactory.createBuilder(sodiumOpts)
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(BuilderFactory.arenaMemoryAllocatorFactory.createBuilder(sodiumOpts)
