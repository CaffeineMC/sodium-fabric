...
public class SodiumGameOptionPages {
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(Text.translatable("sodium.options.entity_geometry_culling.name"))
                        .setTooltip(Text.translatable("sodium.options.entity_geometry_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
                        .setBinding((opts, value) -> opts.performance.useAggressiveGeometryCulling = value, opts -> opts.performance.useAggressiveGeometryCulling)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
