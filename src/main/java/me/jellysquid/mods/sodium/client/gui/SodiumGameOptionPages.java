    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.view_distance"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.view_distance"))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.brightness"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.brightness"))
                        .setControl(opt -> new SliderControl(opt, 0, 100, 1, ControlValueFormatter.brightness()))
                        .setBinding((opts, value) -> opts.gamma = value * 0.01D, (opts) -> (int) (opts.gamma / 0.01D))
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.clouds"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.clouds"))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.fog"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.fog"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.gui_scale"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.gui_scale"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.fullscreen"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.fullscreen"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> {
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.v_sync"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.v_sync"))
                        .setControl(TickBoxControl::new)
                        .setBinding(new VanillaBooleanOptionBinding(Option.VSYNC))
                        .setImpact(OptionImpact.VARIES)
                        .build())
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.fps_limit"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.fps_limit"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.view_bobbing"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.view_bobbing"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(AttackIndicator.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.attack_indicator"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.attack_indicator"))
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(GraphicsMode.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.graphics_quality"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.graphics_quality"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.clouds_quality"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.clouds_quality"))
                        .setControl(option -> new CyclingControl<>(option, SodiumGameOptions.GraphicsQuality.class))
                        .setBinding((opts, value) -> opts.quality.cloudQuality = value, opts -> opts.quality.cloudQuality)
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.weather_quality"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.weather_quality"))
                        .setControl(option -> new CyclingControl<>(option, SodiumGameOptions.GraphicsQuality.class))
                        .setBinding((opts, value) -> opts.quality.weatherQuality = value, opts -> opts.quality.weatherQuality)
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(ParticlesOption.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.particle_quality"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.particle_quality"))
                ...
                .add(OptionImpl.createBuilder(SodiumGameOptions.LightingQuality.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.smooth_lighting"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.smooth_lighting"))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.biome_blend"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.biome_blend"))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.entity_distance"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.entity_distance"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.entity_shadows"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.entity_shadows"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.entityShadows = value, opts -> opts.entityShadows)
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.vignette"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.vignette"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        .setName(I18n.translate("sodium.options.names.mipmap_levels"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.mipmap_levels"))
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumGameOptions.ChunkRendererBackendOption.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.chunk_renderer"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.chunk_renderer"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_chunk_face_culling"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_chunk_face_culling"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_compact_vertex_format"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_compact_vertex_format"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_fog_occlusion"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_fog_occlusion"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_entity_culling"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_entity_culling"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_particle_culling"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_particle_culling"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.animate_only_visible_textures"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.animate_only_visible_textures"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.use_memory_intrinsics"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.use_memory_intrinsics"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(I18n.translate("sodium.options.names.disable_driver_blacklist"))
                        .setTooltip(I18n.translate("sodium.options.tooltips.disable_driver_blacklist"))
                        .setControl(TickBoxControl::new)
