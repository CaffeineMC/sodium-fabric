    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        .setName(new TranslatableComponent("sodium.options.max_pre_rendered_frames.name"))
                        .setTooltip(new TranslatableComponent("sodium.options.max_pre_rendered_frames.tooltip"))
