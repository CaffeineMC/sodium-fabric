...
import me.jellysquid.mods.sodium.client.model.vertex.formats.screen_quad.ScreenQuadVertexType;
...
public class VanillaVertexTypes {
    ...
    public static final VanillaVertexType<ScreenQuadVertexSink> SCREEN_QUADS = new ScreenQuadVertexType();
}
