...
public class SodiumMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        this.logger.info("Loaded configuration file for Sodium: {} options available, {} override(s) found", this.config.getOptionCount(), this.config.getOptionOverrideCount());
    }
