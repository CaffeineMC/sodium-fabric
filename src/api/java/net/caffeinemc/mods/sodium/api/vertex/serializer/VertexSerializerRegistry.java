...
public interface VertexSerializerRegistry {
    ...
    VertexSerializerRegistry INSTANCE = DependencyInjection.load(VertexSerializerRegistry.class, "me.jellysquid.mods.sodium.client.render.vertex.serializers.VertexSerializerRegistryImpl");
