...
public class DirectBufferBuilder implements VertexConsumer, VertexBufferWriter {
    ...
    private final BufferBuilderExtension builder;
    ...
    public DirectBufferBuilder(BufferBuilderExtension builder) {
